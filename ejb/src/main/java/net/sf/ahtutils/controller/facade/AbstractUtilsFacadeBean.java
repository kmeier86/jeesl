...
public class AbstractUtilsFacadeBean implements UtilsFacade
{
	...
	// Persist
	@Override public <T extends EjbSaveable> void save(List<T> list) throws JeeslConstraintViolationException,JeeslLockingException {fUtils.save(list);}
	
	@TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
	@Override public <T extends EjbSaveable> T saveTransaction(T o) throws JeeslConstraintViolationException,JeeslLockingException {return fUtils.save(o);}
	
	@TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
	@Override public <T extends EjbSaveable> void saveTransaction(List<T> list) throws JeeslConstraintViolationException,JeeslLockingException {fUtils.save(list);}
	
	@TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
	@Override public <T extends EjbMergeable> T mergeTransaction(T o) throws JeeslConstraintViolationException, JeeslLockingException {return fUtils.mergeTransaction(o);}

	@Override public <T extends EjbMergeable> T merge(T o) throws JeeslConstraintViolationException, JeeslLockingException{return fUtils.merge(o);}
	
	@Override public <T extends EjbSaveable> T save(T o) throws JeeslConstraintViolationException,JeeslLockingException {return fUtils.save(o);}
	public <T extends EjbWithId> T saveProtected(T o) throws JeeslConstraintViolationException,JeeslLockingException {return fUtils.saveProtected(o);}
	
	public <T extends Object> T persist(T o) throws JeeslConstraintViolationException {return fUtils.persist(o);}
	public <T extends Object> T update(T o) throws JeeslConstraintViolationException, JeeslLockingException {return fUtils.update(o);}
	...
	public <T extends EjbRemoveable> void rm(Set<T> set) throws JeeslConstraintViolationException {fUtils.rm(set);}
	@TransactionAttribute(TransactionAttributeType.REQUIRES_NEW) public <T extends EjbRemoveable> void rmTransaction(List<T> list) throws JeeslConstraintViolationException {fUtils.rm(list);}
	public <T extends EjbRemoveable> void rm(List<T> list) throws JeeslConstraintViolationException {fUtils.rm(list);}
	public <T extends Object> void rmProtected(T o) throws JeeslConstraintViolationException {fUtils.rmProtected(o);}
	
	// Finder
	public <T extends EjbWithId> T find(Class<T> type, T t) {return fUtils.find(type, t);}
	public <T extends Object> T find(Class<T> type, long id) throws JeeslNotFoundException {return fUtils.find(type, id);}
	public <T extends EjbWithName> T fByName(Class<T> type, String name) throws JeeslNotFoundException {return fUtils.fByName(type, name);}
	@Override public <T extends EjbWithEmail> T fByEmail(Class<T> c, String email) throws JeeslNotFoundException {return fUtils.fByEmail(c, email);}
	...
	@Override public <T extends EjbWithCode, E extends Enum<E>> T fByCode(Class<T> c, E code) throws JeeslNotFoundException {return fUtils.fByCode(c, code);}
	@Override public <T extends EjbWithCode> T fByCode(Class<T> c, String code) throws JeeslNotFoundException {return fUtils.fByCode(c, code);}
	@Override public <T extends EjbWithNrString> T fByNr(Class<T> c, String nr) throws JeeslNotFoundException {return fUtils.fByNr(c, nr);}
	@Override public <T extends EjbWithTypeCode> T fByTypeCode(Class<T> c, String type, String code) throws JeeslNotFoundException {return fUtils.fByTypeCode(c,type,code);}
	...
	// Parent
	@Override public <T extends EjbWithParentAttributeResolver, I extends EjbWithId> T oneForParent(Class<T> type, I p1) throws JeeslNotFoundException{return fUtils.oneForParent(type, p1);}
	...
	public <T extends EjbWithId, I extends EjbWithId> T oneForParent(Class<T> cl, String p1Name, I p1) throws JeeslNotFoundException {return fUtils.oneForParent(cl, p1Name, p1);}
	public <T extends EjbWithNr, P extends EjbWithId> T fByNr(Class<T> type, String parentName, P parent, long nr) throws JeeslNotFoundException {return fUtils.fByNr(type, parentName, parent, nr);}
	public <T extends EjbWithId, P extends EjbWithId> T oneForParents(Class<T> cl, List<ParentPredicate<P>> parents) throws JeeslNotFoundException {return fUtils.oneForParents(cl, parents);}
	public <T extends EjbWithId, I extends EjbWithId> T oneForParents(Class<T> cl, String p1Name, I p1, String p2Name, I p2) throws JeeslNotFoundException {return fUtils.oneForParents(cl, p1Name, p1, p2Name, p2);}
	public <T extends EjbWithId, I extends EjbWithId> T oneForParents(Class<T> cl, String p1Name, I p1, String p2Name, I p2, String p3Name, I p3) throws JeeslNotFoundException {return fUtils.oneForParents(cl,p1Name,p1,p2Name,p2,p3Name,p3);}
	...
	// ValidFrom
	@Override public <T extends EjbWithValidFromUntil> T oneInRange(Class<T> c, Date record) throws JeeslNotFoundException {return fUtils.oneInRange(c, record);}
	@Override public <T extends EjbWithValidFromAndParent, P extends EjbWithId> T fFirstValidFrom(Class<T> c, P parent, Date validFrom) throws JeeslNotFoundException {return fUtils.fFirstValidFrom(c,parent,validFrom);}
	@Override public <T extends EjbWithValidFrom> T fFirstValidFrom(Class<T> type, String parentName, long id, Date validFrom) throws JeeslNotFoundException {return fUtils.fFirstValidFrom(type, parentName, id, validFrom);}
	...
	//Year
	public <T extends EjbWithYear, P extends EjbWithId> T fByYear(Class<T> type, String p1Name, P p, int year) throws JeeslNotFoundException {return fUtils.fByYear(type, p1Name, p, year);}

	//Visibility
	@Override public <T extends EjbWithVisible, P extends EjbWithId> List<T> allVisible(Class<T> cl) {return fUtils.allVisible(cl);}
